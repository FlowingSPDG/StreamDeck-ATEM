...
namespace ATEM_StreamDeck
{
    ...
    public class ProgramAction : ATEMActionBase
    {
        #region Private Members

        private ProgramActionSettings settings;
        ...
        protected override void InitializeSettings(InitialPayload payload)
        {
            ...
            {
                this.settings = new ProgramActionSettings();
                this.settings.SetDefaults();
                SaveSettings();
            }
            else
            {
                this.settings = payload.Settings.ToObject<ProgramActionSettings>();
            }
        }
